...
namespace DentalManagementSystem.Data.Migrations
{
    ...
    [Migration("20241103100420_SeedProcedure")]
    partial class SeedProcedure
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DentalManagementSystem.Data.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppointmentId = new Guid("6d70d5fd-ef1e-4b20-b278-aaf6512abad0"),
                            AppointmentDate = new DateTime(2024, 11, 3, 10, 4, 19, 894, DateTimeKind.Utc).AddTicks(708),
                            AppointmentStatus = 0,
                            AppointmentTypeId = 1,
