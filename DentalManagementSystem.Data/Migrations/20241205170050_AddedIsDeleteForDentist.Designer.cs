...
namespace DentalManagementSystem.Data.Migrations
{
    ...
    [Migration("20241205170050_AddedIsDeleteForDentist")]
    partial class AddedIsDeleteForDentist
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DentalManagementSystem.Data.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppointmentId = new Guid("d15c98cd-d68d-442b-8307-b6d000fc1ab9"),
                            AppointmentDate = new DateTime(2024, 12, 5, 17, 0, 48, 923, DateTimeKind.Utc).AddTicks(9358),
                            AppointmentStatus = 0,
                            AppointmentTypeId = 1,
