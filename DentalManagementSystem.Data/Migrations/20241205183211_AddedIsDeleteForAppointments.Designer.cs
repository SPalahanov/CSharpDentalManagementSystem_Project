...
namespace DentalManagementSystem.Data.Migrations
{
    ...
    [Migration("20241205183211_AddedIsDeleteForAppointments")]
    partial class AddedIsDeleteForAppointments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DentalManagementSystem.Data.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppointmentId = new Guid("d74b97db-a784-4fe4-8576-3b0108d79fe4"),
                            AppointmentDate = new DateTime(2024, 12, 5, 18, 32, 9, 101, DateTimeKind.Utc).AddTicks(5765),
                            AppointmentStatus = 0,
                            AppointmentTypeId = 1,
