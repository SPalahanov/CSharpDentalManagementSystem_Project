...
namespace DentalManagementSystem.Data.Migrations
{
    ...
    [Migration("20241205024912_AddedIsDeleteForPatients")]
    partial class AddedIsDeleteForPatients
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DentalManagementSystem.Data.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppointmentId = new Guid("f32fa48f-86eb-44ec-81a4-9d812efee86f"),
                            AppointmentDate = new DateTime(2024, 12, 5, 2, 49, 9, 678, DateTimeKind.Utc).AddTicks(8010),
                            AppointmentStatus = 0,
                            AppointmentTypeId = 1,
